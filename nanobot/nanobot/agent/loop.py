...
class AgentLoop:
    ...
    def _update_tool_contexts(self, channel: str, chat_id: str, session_key: str) -> None:
        """Push current routing context into tools that support it."""
        for tool_name in ("message", "spawn", "cron", "delegate_project_task", "delegate_projects_batch"):
    ...
    async def _process_message(self, msg: InboundMessage) -> OutboundMessage | None:
        ...
        logger.info(f"Processing message from {msg.channel}:{msg.sender_id}:{msg.chat_id} {preview}")
